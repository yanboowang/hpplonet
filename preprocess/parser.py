...
class KITTI(Dataset):
    ...
    def __init__(self, root,  # directory where data is
        ...
        self.voxelmap = {"sp_dpp_10240": "spherical_deepplusplus_10240",
                         ...
                         "ca_0.3_8192_50_-10_uud_c_de": "mean_normal_cartesian_0.3_8192_50_-10_ucuzdd_com_dense",
    ...
    def load_data(self, seqindex, bindex, flag, seqstepsize):
        ...
        if self.lossalldata is not None and self.showtestloss:
            ...
            data["lossalldata"] = np.load(os.path.join(self.root, '{0:02d}'.format(seqindex), "npointsloss_",
