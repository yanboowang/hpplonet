...
from model.voxelnetvlad.pointnet2_old import pointnet2_utils as pointnet2_utils_pt
# from model.voxelnetvlad.pointnet2 import pointnet2_utils
...
class estimate_normal(nn.Module):
    ...
    def forward(self, des_pc, pc2_l0, color2, feat2_l0_1):
        ...
        Return:
            ...
            new_points_concat: sample points feature data, [B, D', S]
        """
        # print("des_pc", des_pc.shape)
        # print("pc2_l0", pc2_l0.shape)
        # print("color2", color2.shape)
        # print("feat2_l0_1", feat2_l0_1.shape)
